...
SERVER_OBJS=src/server/main_server.o src/server/server.o src/server/handlers/handler_auth.o src/server/handlers/handler_movie.o src/server/handlers/handler_show.o src/server/handlers/handle_admin.o src/server/handlers/handler_booking.o
